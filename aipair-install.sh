...
FILES=(aipair aipair-relay aipair-relay-here peer peer-log
       ...
       aipairlib/schema_guard.py aipairlib/relay.py)
...
for _f in bin/aipair bin/aipair-relay bin/aipair-relay-here bin/peer bin/peer-log \
          ...
          bin/aipairlib/corelib.py bin/aipairlib/loglib.py bin/aipairlib/tmuxlib.py bin/aipairlib/deliverylib.py bin/aipairlib/dialoglib.py bin/aipairlib/schema_guard.py \
