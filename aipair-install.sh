...
FILES=(aipair aipair-relay aipair-relay-here peer peer-log
       ...
       aipairlib/schema_guard.py aipairlib/review_protocol.py aipairlib/gate.py aipairlib/log_lock.py aipairlib/relay.py)
...
for _f in bin/aipair bin/aipair-relay bin/aipair-relay-here bin/peer bin/peer-log \
          ...
          bin/aipairlib/corelib.py bin/aipairlib/loglib.py bin/aipairlib/tmuxlib.py bin/aipairlib/deliverylib.py bin/aipairlib/dialoglib.py bin/aipairlib/schema_guard.py bin/aipairlib/review_protocol.py bin/aipairlib/gate.py bin/aipairlib/log_lock.py \
