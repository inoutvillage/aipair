...
FILES=(aipair aipair-relay aipair-relay-here peer peer-log
       ...
       aipairlib/schema_guard.py aipairlib/review_protocol.py aipairlib/gate.py aipairlib/log_lock.py aipairlib/cli.py aipairlib/state_machine.py aipairlib/plan_flow.py aipairlib/question_flow.py aipairlib/relay.py)
